...
public:
    ...
    void set_defense_descriptions(const std::vector <std::string>& defense_descriptions); //adds defense descriptions to the player
...
private:
    ...
    std::vector <std::string> defense_descriptions;
